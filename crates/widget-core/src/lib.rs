...
//!
//! | Macro | Widget | Description |
//! |-------|--------|-------------|
//! | `txt!` | [`Text`] | Display text (static or reactive) |
//! | `btn!` | [`Button`] | Clickable button |
//! | `col!` | [`Column`] | Vertical layout |
//! | `row!` | [`Row`] | Horizontal layout |
//! | `form!` | [`Form`] | Input form container |
...
//! - **Children**: List of child widgets (for containers).
//!
//! # Examples
//!
